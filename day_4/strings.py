...
len = len(phrase)
index = string.index(phrase)
print(string[index:(index + len)])
...
# Which one of the following variables return True when we use the method isidentifier(): 30DaysOfPython, thirty days of python
print('30DaysOfPython'.isidentifier())
print('thirty days of python'.isidentifier())
print('Neither')
